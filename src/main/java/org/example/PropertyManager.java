...
public class PropertyManager {
    ...
    public static Logger LOGGER = LogManager.getLogger(com.eka.middleware.service.PropertyManager.class);
    ...
    public static final Properties getProperties(DataPipeline dataPipeLine, String fileName) throws SnippetException {
        ...
        String packagePath = com.eka.middleware.service.PropertyManager.getPackagePath(dataPipeLine.rp.getTenant()) + "packages/";
    ...
    public static Properties getGlobalProperties(String tenantName) {
        String packagePath = com.eka.middleware.service.PropertyManager.getPackagePathByTenantName(tenantName) + "packages/";
